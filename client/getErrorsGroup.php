...
$data['suspicious'] = $_GET['group']; // Sumnjava riječ / greška. Ovo nije ID, nego errorPhrase
$data['num_occur'] = 354; // Broj pojavljivanja greške (errorPhrase-a koji može biti isti za različite ID-ove ERRORa), isto kao u getErrors (SUM stupca numOccur u tablici ERRORS)
